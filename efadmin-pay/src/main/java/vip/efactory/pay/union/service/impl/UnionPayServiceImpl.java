package vip.efactory.pay.union.service.impl;
...
import vip.efactory.pay.union.util.UnionConfig;
...
public class UnionPayServiceImpl implements IUnionPayService {
    ...
    public String unionPay(Product product) {
        ...
        requestData.put("txnAmt", ComputeUtil.subZeroAndDot(product.getTotalFee()));             //交易金额，单位分，不要带小数点
