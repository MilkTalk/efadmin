package vip.efactory.pay.wx.controller;
...
import vip.efactory.pay.common.utils.AddressUtils;
import vip.efactory.pay.common.utils.DateUtil;
import vip.efactory.pay.wx.service.IWxPayService;
import vip.efactory.pay.wx.util.ConfigUtil;
import vip.efactory.pay.wx.util.HttpUtil;
import vip.efactory.pay.wx.util.PayCommonUtil;
import vip.efactory.pay.wx.util.XMLUtil;
import vip.efactory.pay.wx.util.mobile.MobileUtil;
...
public class WxMobilePayController {
    ...
    @Autowired
    private IWxPayService weixinPayService;
