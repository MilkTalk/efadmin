package vip.efactory.pay.ali.service.impl;
...
import vip.efactory.pay.ali.service.IAliPayService;
import vip.efactory.pay.ali.util.AliPayConfig;
import vip.efactory.pay.common.constants.Constants;
import vip.efactory.pay.common.model.Product;
import vip.efactory.pay.common.utils.ComputeUtil;
...
public class AliPayServiceImpl implements IAliPayService {
    ...
    public String aliPay(Product product) {
        ...
        String totalAmount = ComputeUtil.divide(product.getTotalFee(), "100").toString();
    ...
    public String aliRefund(Product product) {
        ...
        String refundAmount = ComputeUtil.divide(product.getTotalFee(), "100").toString();
